; file: drivers/wire1.asm   target: ATmega128L-4MHz-STK300
...
wire1_write:
    ...
    ; Prend la valeur de a0, et déplace le dernier bit en premiere position.
    ; Si le bit déplacé est un 1, carry "s'allume".
    ror     a0
