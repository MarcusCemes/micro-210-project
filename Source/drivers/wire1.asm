...
.macro	WIRE1	; t0,t1,t2
	...
	bst	w,DQ_pin			; store result in T    stoque le bit DQ_PIN de w dans T
	ldi	w,(@2+1)/2	
...
wire1_reset:	WIRE1	480,70,410				;lire la page 241
wire1_write0:	WIRE1	56,4,1		; diff avec write1 ? apparement write ecrit un bit a 0 et write1 ecrit un bit a 1
...
wire1_write:
	push	a1
	ldi	a1,8
	ror	a0			;prend la valeur de a0, et déplace le dernier bit en premiere position. Si le bit déplacé est un 1, carry "s'allume"
